const coreF = (function (params) {
    return {
        ...
        getPhotoPost: function (id) {
            return this.photoPosts.find(element => {
        ...
        addPhotoPost(photoPost) {
            if (this.validatePhotoPost(photoPost)) {
                ...
                this.photoPosts.sort((element1, element2) => {
        ...
        editPhotoPost: function (id, photoPost) {
            let postToChange = this.getPhotoPost.call({ photoPosts: this.photoPosts }, id);
        ...
        removePhotoPost: function (id) {
            let index = this.photoPosts.findIndex(element => {
                return element.id == id;
            });
            if (index != -1) {
